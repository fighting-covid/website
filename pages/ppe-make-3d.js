  ...
  return (
    <>
      ...
      <main>
          ...
          <h2 className="text-center md:text-3xl text-4xl pb-4 heading"  style={{"margin-left": "50px"}}>
              {"3D Printing"}
            </h2>
          </div>
          ...
          <section className="flex flex-wrap-reverse md:justify-center">
                     ...
                     <h2 className="font-mono lg:text-2xl text-xll" style={{ color: "#304352" }}>
                         Face Shield
                       </h2>
                  </div>
          <div className="md:p-5">
            ...
            <div
              ...
              >
               ...
               <div className="modelo-wrapper"> <div style={{ marginBottom: '0%', width: '100%', height: '100%', paddingBottom: '56.25%', position: 'relative' }}> <div style={{ position: 'absolute', top: 0, bottom: 0, left: 0, right: 0 }}> <iframe src="https://app.modelo.io/embedded/R7_6wlbu7K?viewport=true&autoplay=true" style={{ width: '100%', height: '100%' }} frameBorder={0} /> </div> </div> </div>
