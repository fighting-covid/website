		...
		<>
			...
			<main className="container mx-auto">
				<section className="p-8">
					<h2 className="font-serif font-bold md:text-5xl text-4xl heading">The Mission</h2>
					<Markdown className="text-xl markdown-body">{data.mission}</Markdown>
				</section>
				<section className="p-8">
					<h2 className="font-serif font-bold md:text-5xl text-4xl heading">The Members</h2>
					{data.teams.map(team => (
